...
public class TestRemoveRecursive {
  ...
  public void test() {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method commit is undefined for the type TestRemoveRecursive"
      + "\nThe method or field Success is undefined for the type TestRemoveRecursive"
      + "\nThe method commit is undefined for the type TestRemoveRecursive"
      + "\nThe method size is undefined for the type TestRemoveRecursive"
      + "\nThe method close is undefined for the type TestRemoveRecursive"
      + "\nThe method shutdown is undefined for the type TestRemoveRecursive"
